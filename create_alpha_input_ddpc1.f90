...
REAL ::  bind,l,m,s1p,s2p,s1n,s2n,salpha,qvalue,BEalpha,deltap
...
deltap=0.50d0*(BE(pz,pa)+BE(pz-2,pa)-2.0d0*BE(pz-1,pa))
deltan=0.50d0*(BE(pz,pa)+BE(pZ,pa-2)-2.0d0*BE(pz,pa-1))
